...
public interface JQuickJSONListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link JQuickJSONParser#float}.
     *
     * @param ctx the parse tree
     */
    void enterFloat(JQuickJSONParser.FloatContext ctx);

    /**
     * Exit a parse tree produced by {@link JQuickJSONParser#float}.
     *
     * @param ctx the parse tree
     */
    void exitFloat(JQuickJSONParser.FloatContext ctx);

    /**
     * Enter a parse tree produced by {@link JQuickJSONParser#double}.
     *
     * @param ctx the parse tree
     */
    void enterDouble(JQuickJSONParser.DoubleContext ctx);

    /**
     * Exit a parse tree produced by {@link JQuickJSONParser#double}.
     *
     * @param ctx the parse tree
     */
    void exitDouble(JQuickJSONParser.DoubleContext ctx);
    ...
    /**
     * Enter a parse tree produced by {@link JQuickJSONParser#date}.
     *
     * @param ctx the parse tree
     */
    void enterDate(JQuickJSONParser.DateContext ctx);

    /**
     * Exit a parse tree produced by {@link JQuickJSONParser#date}.
     *
     * @param ctx the parse tree
     */
    void exitDate(JQuickJSONParser.DateContext ctx);
